const WORKER_CAPABILITIES = Object.freeze([
  ...
  },
  {
    ...
    domains: ["SALES","BUSINESS_DEVELOPMENT","PROSPECTING","ACCOUNT"],
    actions: ["ANALYZE","RESEARCH","PREPARE","QUALIFICATION","ACCOUNT_MAPPING","OUTREACH_DRAFT","STATUS_REPORT","EXTERNAL_CONTACT"],
    tools: ["HUBSPOT_READ","NOTION_READ","EXA","WEB_RESEARCH"],
    authority: ["ANALYSIS_ONLY","EXECUTE_WITHIN_ROLE","APPROVAL_REQUIRED"]
  }
]);
